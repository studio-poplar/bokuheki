...
export const history: TimelineEntry[] = [
  { year: "1958", text: "初代・灰谷 徳治、京都市左京区にて左官業を創業。社寺仏閣の土壁修繕を中心に手がける。" },
  { year: "1979", text: "二代目・灰谷 修二が継承。数寄屋建築の需要増加にあわせ、茶室・料亭の内装左官を強化。" },
  { year: "1991", text: "有限会社 灰谷左官店として法人化。職人数8名体制に。" },
  { year: "2004", text: "独自配合の黒漆喰「黒聚楽」を開発。以降、店舗・現代建築からの依頼が増加。" },
  { year: "2016", text: "三代目・灰谷 誠一が代表就任。版築による外構・店舗施工を本格展開。" },
...
export const companyInfo = [
  { label: "社名", value: "有限会社 灰谷左官店（屋号：墨壁 -BOKUHEKI-）" },
  { label: "創業", value: "1958年（昭和33年）" },
  { label: "代表", value: "代表取締役　灰谷 誠一（三代目）" },
